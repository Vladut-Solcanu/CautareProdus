...
1. **Căutare inteligentă după nume (LINQ):** - Utilizatorul introduce numele (sau o parte din numele) produsului căutat.
...
2. **Afișarea detaliată a locației produsului:**
...
3. **Gestiunea stocurilor / locațiilor (Mod Angajat):**
